...
<head>
    ...
    <title>Reports - BeU Delivery</title>
    ...
    <div class="dashboard-wrapper">
        ...
        <div class="sidebar">
            ...
            <nav class="nav flex-column">
                ...
                <a href="orders_simple.php" class="nav-link">
                ...
                <a href="reports_simple.php" class="nav-link active">
        ...
        <div class="main-content">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Track your business performance</p>
                </div>
            </div>
            
            <div class="stat-card">
                <h4>Reports & Analytics</h4>
                <p>This is the reports page with the correct sidebar UI.</p>
                <p>The sidebar should show:</p>
                <ul>
                    <li>Black background</li>
                    <li>Store name with "Active" badge</li>
                    <li>Navigation menu with "Reports" highlighted</li>
                </ul>
                
                <div class="alert alert-info">
                    <i class="bi bi-info-circle me-2"></i>
                    This is a simplified version to test the UI. Charts and analytics will be added once the UI is working correctly.
                </div>
            </div>
        </div>
    </div>
